...
REAL_PHOTOS = {
    ...
    'sold-8': ('/assets/photos/sold-liquor-license-icon.jpg', 1600, 1200),
    ...
    'sold-35': ('/assets/photos/sold-84-avenue-unit-102.jpg', 1448, 1086),
    'sold-36': ('/assets/photos/sold-84-avenue-unit-103.jpg', 1200, 800),
    'sold-37': ('/assets/photos/sold-84-avenue-unit-104.jpg', 1537, 1023),
    'sold-38': ('/assets/photos/sold-84-avenue-unit-105.jpg', 1200, 800),
    'sold-39': ('/assets/photos/sold-84-avenue-unit-106.jpg', 768, 512),
}
...
AREA_GROUPS = {
    ...
    'Langley': ['langley', 'fort-langley', 'willoughby', 'walnut-grove', 'langley-city', 'brookswood',
                ...
                'highpoint', 'otter-district', 'milner', 'glen-valley', 'uplands'],
    'Delta': ['delta', 'ladner', 'tsawwassen', 'north-delta', 'sunshine-hills', 'annieville',
              'scottsdale', 'boundary-bay'],
...
SOLD_LISTINGS = [
    ...
    dict(street="84 Avenue", area="Surrey", type="Industrial Strata Unit — 103", price="Contact for Price", img_seed="sold-36", category="Commercial"),
    dict(street="84 Avenue", area="Surrey", type="Industrial Strata Unit — 104", price="Contact for Price", img_seed="sold-37", category="Commercial"),
    dict(street="Balsam Crescent", area="Elgin Chantrell", type="Acreage", price="$3,300,000", img_seed="sold-7", category="Residential"),
    ...
    dict(street="77 Avenue", area="Fleetwood", type="Single-Family", price="Contact for Price", img_seed="sold-10", category="Residential"),
    ...
    dict(street="84 Avenue", area="Surrey", type="Industrial Strata Unit — 102", price="Contact for Price", img_seed="sold-35", category="Commercial"),
    ...
    dict(street="128 Street", area="Surrey", type="Industrial Strata Unit — #16", price="Contact for Price", img_seed="sold-7711-2", category="Commercial"),
    ...
    dict(street="128 Street", area="Surrey", type="Industrial Strata Unit — #6", price="Contact for Price", img_seed="sold-7711-1", category="Commercial"),
    dict(street="", area="Abbotsford", type="Liquor License", price="Contact for Price", img_seed="sold-8", category="Commercial"),
    dict(street="84 Avenue", area="Surrey", type="Industrial Strata Unit — 106", price="Contact for Price", img_seed="sold-39", category="Commercial"),
    ...
    dict(street="84 Avenue", area="Surrey", type="Industrial Strata Unit — 105", price="Contact for Price", img_seed="sold-38", category="Commercial"),
